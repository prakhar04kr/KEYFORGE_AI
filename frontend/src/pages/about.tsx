...
const featureIcons = [
  ...
  { icon: Sparkles, title: "Dynamic Practice Content", desc: "Adaptive prompts designed to challenge your weak spots." },
  ...
  { icon: Activity, title: "Personalized Feedback", desc: "Smart coaching to improve efficiently." },
    ...
    <div className="space-y-16 pb-16">
      ...
      <section className="text-center pt-16 pb-6">
        ...
        >
          <h1 className="text-4xl md:text-6xl font-bold font-mono min-h-[4rem] flex items-center justify-center">
            <span className="text-transparent bg-clip-text bg-gradient-to-r from-primary to-primary/50">KEYFORGE</span>
          </h1>

          <p className="text-xl md:text-2xl text-muted-foreground max-w-3xl mx-auto font-mono">
            Typing Practice & Performance Analytics Platform
          </p>

          <p className="text-base md:text-lg text-foreground/80 max-w-3xl mx-auto leading-relaxed">
            KeyForge is a typing practice platform designed to help users improve typing speed, accuracy, coding proficiency, and overall keyboard efficiency through analytics, dynamic content, performance tracking, and personalized feedback.
          </p>
        ...
        <div className="mt-6 grid grid-cols-1 md:grid-cols-2 gap-6">
          <Card className="bg-card/50 backdrop-blur border-border/50">
            <CardContent className="p-6 space-y-3">
              ...
              <p className="text-lg font-mono">KeyForge combines typing practice with modern analytics and adaptive learning.</p>
            ...
            <CardContent className="p-6 space-y-4">
              ...
              <div className="grid grid-cols-1 gap-3">
                {[ 
                  ...
                  { t: "Personalized Feedback", d: "Coaching that adapts to your patterns." },
                ].map((x) => (
      ...
      <section className="max-w-6xl mx-auto">
        ...
        <div className="mt-8 grid grid-cols-1 md:grid-cols-3 gap-4">
          ...
          <Card className="bg-card/50 backdrop-blur border-border/50">
            <CardContent className="p-6 space-y-3">
              <p className="text-xs font-mono text-muted-foreground uppercase tracking-wider">Content Engine</p>
              <p className="font-mono text-primary">Google Gemini API</p>
              <p className="text-sm text-muted-foreground">Adaptive feedback and dynamic practice content.</p>
            </CardContent>
          </Card>
      ...
      <section className="max-w-6xl mx-auto">
        ...
        <div className="mt-8 grid grid-cols-1 md:grid-cols-5 gap-4">
          {[ 
            ...
            { n: 4, t: "Receive coaching feedback", d: "Improve faster with personalized tips." },
        ...
        <div className="mt-8 grid grid-cols-1 md:grid-cols-3 gap-4">
          <Card className="bg-card/50 backdrop-blur border-border/50 md:col-span-2">
            <CardContent className="p-6 space-y-4">
              ...
              <p className="text-sm text-muted-foreground leading-relaxed">
                Prakhar Kumar is a Computer Science & Engineering student passionate about software development, full-stack web development, and building impactful technology solutions. KeyForge was developed as a modern typing and analytics platform that combines performance tracking with data-driven insights to create a smarter learning experience.
              </p>
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-3">
                ...
                <div className="p-3 rounded-lg bg-background/40 border border-border/30">
                  ...
                  <p className="font-mono text-foreground">Full-stack • Performance analytics</p>
                </div>
              </div>
          ...
          <Card className="bg-primary/5 border-primary/20">
            <CardContent className="p-6 space-y-3">
              ...
              <p className="text-sm text-muted-foreground leading-relaxed">
                KeyForge emphasizes fast feedback loops, reliable code rendering, and analytics you can actually use.
              </p>
              <div className="pt-2">
                <Link href="/type/coding">
            ...
            <div className="flex flex-col md:flex-row items-start md:items-center justify-between gap-6">
              <div className="space-y-3">
                ...
                <p className="text-muted-foreground leading-relaxed max-w-2xl">
                  Start practicing with KeyForge and track your growth using powerful analytics and performance insights.
                </p>
              </div>
